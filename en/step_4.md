...
In this step, you will set the scene by creating or choosing a backdrop. You will also create and/or choose sprites go in front of the backdrop. In this step, you will also drag your sprites to layer them.
...
**Tip:** If you find it hard to manage the sprites on your Stage, such as having a large sprite that keeps covering a much smaller one, you can click **hide** so that you don't see the sprite or sprites. Then, when you have finished, click **show** again.
